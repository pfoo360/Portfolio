const Blobs = () => {
  return (
    <div className="relative w-full max-w-xs">
      ...
      <div className="absolute -bottom-48 left-20 w-40 h-40 bg-[#c7def8] rounded-full mix-blend-soft-light filter blur-md animate-blob ease-in-out animation-delay-4000" />
    </div>
  );
};
