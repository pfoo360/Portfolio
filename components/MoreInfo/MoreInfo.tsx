  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={handleClose} className="backdrop-blur-sm">
        <>
          <div className="min-w-[20rem] max-h-[44rem] sm:min-w-[37.5rem] md:max-w-[55rem] md:max-h-[50rem] overflow-y-auto bg-white bg-opacity-[0.8] text-primary-black p-2 font-playfair font-normal text-[1rem] leading-[1.5rem] text-justify">
